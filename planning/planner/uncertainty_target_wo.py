...
class UncertaintyTargetPlannerWo(PlannerBase):
    def __init__(self, args, device):
        super(UncertaintyTargetPlannerWo, self).__init__(args, device)
    ...
    def plan_next_view(self):
        ...
        # view_list = np.empty((num_candidate_, 2))
    ...
    def cal_utility(self, num, depth_unc, semantic_unc, semantic, object_ratio):
        ...
        # semantic = semantic.reshape(num, -1)
        ...
        # semantic_mask = cv2.dilate(semantic_mask, kernel)
        ...
        # print(exploitation_utility, exploration_utility)
        # utility_factor = np.mean(depth_unc, where=semantic_mask, axis=-1)
        utility_list = (
